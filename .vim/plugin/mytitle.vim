...
func SetShellTitle()
    ...
    call append(i+15, "F_BL=\"\\033\[30m\"   F_RD=\"\\033\[31m\"   F_GR=\"\\033\[32m\"")
    call append(i+16, "F_YL=\"\\033\[33m\"   F_BU=\"\\033\[34m\"   F_PU=\"\\033\[35m\"")
    call append(i+17, "F_DG=\"\\033\[36m\"   F_WT=\"\\033\[37m\"   B_BL=\"\\033\[40m\"")
    call append(i+18, "B_RE=\"\\033\[41m\"   B_GR=\"\\033\[42m\"   B_YL=\"\\033\[43m\"")
    call append(i+18, "B_BU=\"\\033\[44m\"   B_PR=\"\\033\[45m\"   B_DG=\"\\033\[46m\"")
    call append(i+20, "B_WT=\"\\033\[47m\"")
    call append(i+21, "")
    call append(i+22, "\#-----------------------------------------------------------")
    call append(i+23, "\#                  MAIN PROCESS")
    call append(i+24, "\#-----------------------------------------------------------")
    call cursor(i+26,0)
endfunc
" C&H common TITILE {{{1
